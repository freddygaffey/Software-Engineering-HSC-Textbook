...
>
> **Note:** `20-01-What-is-AI-vs-ML` already exists (the prototype episode, currently
> at `podcast/content/20-01-What-is-AI-vs-ML/`). It predates the two-voice
> `NARRATOR:`/`QUESTION:` format and the `## Appendix` contract — when revisited it
> should be brought up to STYLE.md/SUPPLEMENTARY.md spec and relocated under this
> module folder. Its brief below reflects the *target* form.
...
- **Naming reconciliation:** basename = textbook section (`20-02-ML-Training-Models.md`); `module: SA` in frontmatter; review `22-99-…`; case studies `case_…`. Frontmatter template as in the PFW plan (swap `module: SA`).

### Episode list (teaching order)

| # | Basename | Kind | Dot-point focus | Outcomes |
|---|----------|------|-----------------|----------|
| 1 | `20-01-What-Is-AI-vs-ML` | lesson | AI vs ML; RPA/BPA; DevOps | SE-12-03 |
| 2 | `20-02-ML-Training-Models` | lesson | supervised…reinforcement | SE-12-03 |
| 3 | `20-03-Common-ML-Applications` | lesson | forecasting, assistants, image | SE-12-03 |
| 4 | `20-04-Decision-Trees-And-Neural-Networks` | lesson | design/analysis models | SE-12-02 |
| 5 | `20-05-RPA-And-BPA-Practical-Considerations` | lesson | RPA/BPA implementation, ethics | SE-12-02, SE-12-05 |
| 6 | `21-01-Regression-And-Core-Algorithm-Types` | lesson | linear/logistic/poly, KNN | SE-12-02 |
| 7 | `21-02-Neural-Networks-Concepts-And-Implementation` | lesson | perceptron, MLP, training loop | SE-12-02 |
| 8 | `22-01-Assessing-The-Impact-Of-Automation` | lesson | social/economic/environmental | SE-12-05 |
| 9 | `22-02-Human-Behaviour-Patterns-And-ML-AI` | lesson | psychology, culture, beliefs | SE-12-05 |
| 10 | `22-03-Bias-In-Datasets-And-Models` | lesson | bias sources & mitigation | SE-12-05 |
| 11 | `22-99-Module-Review-Software-Automation` | module-review | whole module | all |
...
- **Interleave:** backward → ML training data = the big data of PFW 11-04; forward → bias (22-03) and privacy (SSA 16-02); link → DevOps automation echoes SEP version control/CI (forward).
