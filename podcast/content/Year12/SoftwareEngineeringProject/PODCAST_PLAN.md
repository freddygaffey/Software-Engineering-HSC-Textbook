# Podcast Plan — Software Engineering Project (SEP)
...
>
> **Special character of this module.** SEP is the **synthesis module** — it is *about
...
> exercise over the course. The SEP outcomes (esp. SE-12-09) reward *managing and
...
- **Module acronym (frontmatter `module:`):** `SEP`
...
- **Naming reconciliation:** basename = textbook section (`24-04-Project-Management-Tools-And-Gantt.md`); `module: SEP` in frontmatter; reviews `XX-99-…`; case studies `case_…`. Frontmatter template as in the PFW plan (swap `module: SEP`).

### Episode list (teaching order)

| # | Basename | Kind | Dot-point focus | Outcomes |
|---|----------|------|-----------------|----------|
| 1 | `23-01-Requirements-And-Feasibility` | lesson | requirements, feasibility, boundaries | SE-12-01 |
| 2 | `23-02-Ideation-And-Modelling-Tools` | lesson | brainstorm, data dictionaries, modelling | SE-12-06 |
| 3 | `23-03-Implementation-Methods` | lesson | direct/phased/parallel/pilot | SE-12-06 |
| 4 | `24-01-Waterfall-Approach` | lesson | waterfall lifecycle | SE-12-06 |
| 5 | `24-02-Agile-Approach` | lesson | agile, iterations, stories | SE-12-06 |
| 6 | `24-03-WAgile-Hybrid-Approach` | lesson | hybrid model | SE-12-06 |
| 7 | `24-04-Project-Management-Tools-And-Gantt` | lesson | scheduling, Gantt, tracking | SE-12-09 |
| 8 | `24-05-Social-Ethical-And-Communication-Issues` | lesson | stakeholders, ethics, feedback | SE-12-05 |
| 9 | `24-06-Quality-Assurance` | lesson | QA criteria, compliance | SE-12-06 |
| 10 | `24-99-Module-Review-Defining-And-Planning` | module-review | Ch 23–24 | all |
| 11 | `25-01-Building-The-Solution` | lesson | incremental build | SE-12-02 |
| 12 | `25-02-Presenting-The-Solution` | lesson | presentation, demo | SE-12-09 |
| 13 | `25-03-Algorithms-Documentation-And-Back-End-Engineering` | lesson | artefacts, back-end contribution | SE-12-06 |
| 14 | `25-04-Data-Backup-And-Version-Control` | lesson | backups, branching, releases | SE-12-06 |
| 15 | `25-05-Overcoming-Development-Difficulties` | lesson | blockers, escalation | SE-12-06 |
| 16 | `25-06-Prototype-And-UI-Design` | lesson | wireframes, usability | SE-12-06 |
| 17 | `26-01-Testing-Methodologies-And-Optimisation` | lesson | test plans, path/boundary | SE-12-08 |
| 18 | `26-02-Feedback-Analysis` | lesson | collect/synthesise feedback | SE-12-09 |
| 19 | `26-03-Evaluating-The-Software-Solution` | lesson | evaluation report, evidence | SE-12-06 |
| 20 | `26-99-Module-Review-Software-Engineering-Project` | module-review | whole module + whole year | all |
...
- **§5.1 recap:** First SEP episode — bridge from SA/SSA/PFW: "you can now build smart, secure web software; this module is how you *run the project* that ships it." Keep opener short.
...
- **Kind:** module-review. **Outcomes:** all SEP so far.
...
- **Kind:** module-review (the **capstone**). **Outcomes:** all SEP + cross-module.
- **Job:** this is the final review of Year 12 — tie SEP's process spine to the technical content of PFW, SSA and SA. Re-surface every SEP mnemonic (FUN-PERF, DiP-PP, Waterfall/Agile/WAgile, Scope-Time-Cost, I-F-N, 3C, T-E-I-S, 3-2-1, C-S-A, C-E-R) **and** call back the marquee hooks from the other modules (CIA-AAA, Hash-one-way, SUSR, S-H-L-M, the request journey). Heaviest `QUESTION:` voice of the course: pose a full integrated HSC-style scenario ("here's a brief — plan, choose a methodology, design it securely, add an ML feature responsibly, build/test/evaluate it") and model an integrated, mark-earning answer. Pull all SEP case studies together and reference the others.
