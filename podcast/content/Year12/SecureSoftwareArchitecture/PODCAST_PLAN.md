...
- **Naming reconciliation:** basename = textbook section (`15-02-Cryptography-And-Data-Protection-Part-1.md`); `module: SSA` in frontmatter; reviews `XX-99-…`; case studies `case_…`. See PFW plan for the frontmatter template (swap `module: SSA`).

### Episode list (teaching order)

| # | Basename | Kind | Dot-point focus | Outcomes |
|---|----------|------|-----------------|----------|
| 1 | `14-01-The-Business-Case-For-Security` | lesson | benefits of secure software | SE-12-01 |
| 2 | `14-02-Integrating-Security-Into-The-SDLC` | lesson | secure dev steps | SE-12-01 |
| 3 | `14-03-User-Centered-Security-Design` | lesson | end-user capability & design | SE-12-03 |
| 4 | `15-01-CIA-Triad-And-AAA` | lesson | confidentiality…accountability | SE-12-07 |
| 5 | `15-02-Cryptography-And-Data-Protection-Part-1` | lesson | hashing vs encryption, password storage | SE-12-07 |
| 6 | `15-02-Cryptography-And-Data-Protection-Part-2` | lesson | symmetric/asymmetric, keys, TLS/certs | SE-12-07 |
| 7 | `16-01-Input-Validation-And-Sanitisation` | lesson | validation, sanitisation, error handling | SE-12-07 |
| 8 | `16-02-Privacy-By-Design` | lesson | privacy-by-design principles | SE-12-04 |
| 9 | `16-99-Module-Review-Security-Foundations-And-Principles` | module-review | Ch 14–16 | all |
| 10 | `17-01-Secure-API-Design` | lesson | safe API, sessions, CORS | SE-12-07 |
| 11 | `17-02-Secure-Execution-And-Resource-Management` | lesson | memory/session/exception mgmt | SE-12-07 |
| 12 | `18-01-Security-Testing-Fundamentals` | lesson | code review, SAST, DAST, pen test | SE-12-06 |
| 13 | `18-02-Web-Application-Vulnerabilities-Part-1` | lesson | XSS, CSRF, invalid forwarding/redirect | SE-12-07 |
| 14 | `18-02-Web-Application-Vulnerabilities-Part-2` | lesson | broken auth/session, race conditions, file/side-channel | SE-12-07 |
| 15 | `19-01-Security-In-Development-Teams` | lesson | collaboration benefits | SE-12-06 |
| 16 | `19-02-Enterprise-Security-Benefits` | lesson | enterprise benefits | SE-12-06 |
| 17 | `19-03-Security-Ethics-And-Legal-Considerations` | lesson | social/ethical/legal | SE-12-05 |
| 18 | `19-04-Evaluating-Security-Programs` | lesson | evaluation, metrics | SE-12-06 |
| 19 | `19-99-Module-Review-Secure-Software-Architecture` | module-review | whole module | all |
...
- **Interleave:** story → `case_the_xz_backdoor` (a *trust*/team failure as much as technical); backward → collaboration & version control (PFW 12-06, Year 11); forward → SEP 24-05 (collaboration & communication) reuses this.
...
- **Interleave:** story → `case_the_xz_backdoor` (open-source ethics, disclosure) and `case_the_equifax_breach` (legal/regulatory); backward → privacy (16-02); forward → SEP 24-05 social/ethical issues.
...
- **Interleave:** backward → ties metrics to the testing toolbox (18-01) and incident lifecycle (H-B-D); forward → SEP 26-03 evaluation reuses the "criteria + evidence" shape.
